...
SRC = main.c path_and_exec.c fd_parse.c my_cmd_proc.c heredoc.c env_copy.c env_list_tools.c swap_val_list.c parser.c errors.c string_cutters.c quotes.c dollar.c list_tools.c pipe_executor.c $(REBUILT_FUNCS)
